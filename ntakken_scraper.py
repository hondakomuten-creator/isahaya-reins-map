...
SEARCH_TARGETS = [
    ...
    # 大村市：全域（city_code=42205 ※サイトのフォームで確認済み）
    ("land_tk",    "0101", 7000000,  "土地",     "42205", None),
    ("house_tk",   "9102", 10000000, "中古住宅", "42205", None),
    ("mansion_tk", "0103", 10000000, "マンション","42205", None),
    # 雲仙市：愛野町・吾妻町のみ
...
def run_scrape():
    ...
    try:
        for category, ptm, min_price, label, city_code, include_areas in SEARCH_TARGETS:
            city_name = {"42204": "諫早市", "42205": "大村市", "42213": "雲仙市"}.get(city_code, city_code)
